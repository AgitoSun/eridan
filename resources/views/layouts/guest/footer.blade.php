        ...
        <div class="row py-5 justify-content-center">
            ...
            <div class="col-md-4 col-lg-3 mb-4 mb-lg-0 text-center text-lg-end">
                <p class="text-7 text-color-light font-weight-bold pb-1 mb-0">
                    <a href="tel:+79160767575" class="text-decoration-none text-color-light">+7 (916) 076-75-75</a>
                </p>
                <p class="m-0"><a href="mailto:sgrudakov@rusdhouse.ru">sgrudakov@rusdhouse.ru</a></p>
            </div>
        </div>
    </div>
        ...
        <div class="container py-2">
            <div class="row py-4">
                ...
                <div class="col-lg-11 d-flex align-items-center justify-content-center justify-content-lg-end mb-4 mb-lg-0">
                    <p>© Copyright Grudakov Sergei Jewelry <script>document.write(new Date().getFullYear());</script>. Все права защищены.</p>
                </div>
            </div>
        </div>
    </div>
